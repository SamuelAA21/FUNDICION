...
<script>
const URL_HORNO_POSTNEW = "<?= htmlspecialchars($URL_HORNO_POSTNEW, ENT_QUOTES, 'UTF-8') ?>";
const URL_HORNO_UPDATE  = "<?= htmlspecialchars($URL_HORNO_UPDATE, ENT_QUOTES, 'UTF-8') ?>";
const URL_HORNO_ONE     = "<?= htmlspecialchars($URL_HORNO_ONE, ENT_QUOTES, 'UTF-8') ?>";
const URL_HORNO_DELETE  = "<?= htmlspecialchars($URL_HORNO_DELETE, ENT_QUOTES, 'UTF-8') ?>";
</script>
